...
def login(payload: LoginRequest, db: Session = Depends(get_db)):
    """POST /api/auth/login - simphiwe@simplycomplexafrica.org.za + password"""
...
def me(current_user: User = Depends(get_current_user)):
    """GET /api/auth/me - used by the frontend on page load to restore the session."""
    return current_user
...
def change_password(
    ...
    """POST /api/auth/change-password - requires the user to know their current password."""
